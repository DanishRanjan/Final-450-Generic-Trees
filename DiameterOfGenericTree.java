...
public class DiameterOfGenericTree {
  ...
  public static Node construct(int[] arr) {
    ...
    static int calculateDiaReturnHeight(Node node){
        ...
        for(Node child: node.children){
            int currentHeight = calculateDiaReturnHeight(child);
            if(currentHeight>deepestChildHeight){
                secondDeepestChildHeight = deepestChildHeight;
                deepestChildHeight = currentHeight;
            }else if(currentHeight>secondDeepestChildHeight){
                secondDeepestChildHeight = currentHeight;
            }
        }
